    ...
    payload = {
        ...
        "events": [
            ...
            {"id": "e2", "title": "Team sync", "start": "T11",
             "attendees": ["dan@crealwork.com", "dave@sundayable.com"]},
            {"id": "e3", "title": "Solo focus", "start": "T12", "attendees": []},
            {"id": "e4", "title": "Room", "start": "T13",
             "attendees": ["room@resource.calendar.google.com", "dan@crealwork.com"]},
            {"id": "e5", "title": "Excluded contractor", "start": "T14",
             "attendees": ["contractor@gmail.com", "dan@crealwork.com"]},
        ],
    }
